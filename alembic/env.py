...
# --- Add your project directory to sys.path so Alembic can find 'app' ---
...
# Override the database URL in alembic.ini (optional)
...
# Target metadata for 'autogenerate' (used by Alembic migrations)
